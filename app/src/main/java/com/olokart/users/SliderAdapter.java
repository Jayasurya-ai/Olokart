...
public class SliderAdapter extends PagerAdapter {
    ...
    private Integer[] images = { R.drawable.slideraaa, R.drawable.sliderbbb,R.drawable.sliderccc,R.drawable.slideraaa};
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        try {
            ...
            view = layoutInflater.inflate(R.layout.activity_slider_adapter, container, false);
