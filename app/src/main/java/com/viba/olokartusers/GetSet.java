package com.viba.olokartusers;
 ...
 class GetSet {
    ...
    String product_name, product_quant,product_quanta,product_quantb, product_image, actual_price,actual_pricea,actual_priceb,name, password, phone, image, address, total_price,
           optionmode, total_quantity,total_quantitya,total_quantityb, actual_quant, suid, product_cat,quantity,date,time, cartuid,sname,scity,slat,slong, simage, sphone,product_subcat,product_price,total_quant,uaddress,delivery,orderid,bagprice;
    ...
    public GetSet() {
     ...
     public GetSet(String total_quantitya, String optionmode, String total_quantityb, String product_quanta, String product_quantb,String product_price,String actual_price,String total_quant,String uaddress,String delivery,String orderid,String bagprice ) {
