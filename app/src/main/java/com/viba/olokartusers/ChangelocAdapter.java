...
class ChangelocAdapter extends RecyclerView.Adapter<ChangelocAdapter.PredictionHolder> implements Filterable {
    ...
    private SearchLocationActivity clickListener;
...
//    }
    ...
    public void setClickListener(SearchLocationActivity searchLocationActivity) {
        this.clickListener = searchLocationActivity;
    }
...
//    }
    ...
    public class PredictionHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        PredictionHolder(View itemView) {
            ...
            progressBar=itemView.findViewById(R.id.progress_location);
...
//                                Intent intentBuilder=getIntentOld(suid);
//                                suid=intentBuilder.getStringExtra("suid");

                                Toast.makeText(mContext, place.getAddress()+", "+place.getLatLng().latitude+place.getLatLng().longitude, Toast.LENGTH_SHORT).show();
                                mContext.startActivity(new Intent(mContext, HomeActivity.class).putExtra("suid",suid).putExtra("address",place.getAddress()));
                                ...
                                locMap.put("ulat", place.getLatLng().latitude);
                                locMap.put("ulong", place.getLatLng().longitude);
                                locMap.put("uaddress", place.getAddress());
