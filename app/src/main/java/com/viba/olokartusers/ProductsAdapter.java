...
public class ProductsAdapter extends RecyclerView.Adapter<ProductsAdapter.HomeViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ProductsAdapter.HomeViewHolder holder, int position) {
        ...
        Picasso.get().load(product.get(position).getProduct_image()).into(holder.imageView);
    ...
    public class HomeViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView imageView;
        String pName, suid, productCat, sphone, product_subcat, product_quan, product_quanta, product_quantb, actual_pricea, actual_priceb, pimage, actual_price, total_quantity, total_quantitya, total_quantityb;
        ...
        public void bind(final GetSet item, final AdapterView.OnItemClickListener listener) {
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(final View v) {
                    ...
                    qtyreference.addValueEventListener(new ValueEventListener() {
                        @Override
                        public void onDataChange(@NonNull final DataSnapshot dataSnapshot) {
                            ...
                            try {
                                ...
                                String maxqtya = dataSnapshot.child("total_quantitya").getValue().toString();
                                String maxqtyb = dataSnapshot.child("total_quantityb").getValue().toString();
                                ...
                                if (maxqtya.equals("0")) {
                                    ...
                                    Snackbar.make(frameLayout, "Item Added to Bag !", 100000).setAction("Open Bag", new View.OnClickListener() {
                                        @Override
                                        ...
                                        public void onValueChange(ElegantNumberButton view, int oldValue, int newValue) {
                                            ...
                                            if (oldValue > newValue) {
                                                ...
                                                if (numberButton.getNumber().equals("0")) {
                                                    Snackbar.make(frameLayout, "Item Removed from Bag ! ", 100000).show();
                                                } else {
                                                    Snackbar.make(frameLayout, "Item Removed from Bag ! ", 100000).setAction("Open Bag", new View.OnClickListener() {
                                                        @Override
                                                        public void onClick(View v) {
...
//                                            Toast.makeText(context, ""+BagPrice, Toast.LENGTH_SHORT).show();
                                    ...
                                    Picasso.get().load(pimage).into(proqtyimage);
...
//
                                    ...
                                    Snackbar.make(layout, "", 100000).setBackgroundTint(Color.WHITE).setActionTextColor(Color.GREEN).setAction("Add to Bag", new View.OnClickListener() {
                                        @Override
                                        public void onClick(View v) {
                                            ...
                                            if (Integer.parseInt(qtynum.getNumber()) > 0) {
                                                ...
                                                databaseReference.child(proName + product_quan).removeValue();
                                            }
                                            ...
                                            if (Integer.parseInt(qtynuma.getNumber()) > 0) {
                                                ...
                                                databaseReference.child(proName + product_quanta).removeValue();
                                            }
//
                                            if (Integer.parseInt(qtynumb.getNumber()) > 0) {
                                                ...
                                                databaseReference.child(proName + product_quantb).removeValue();
                                            }

                                            alertDialog.dismiss();
                                            Snackbar.make(frameLayout, "", 1000000000).setAction("Open Bag", new View.OnClickListener() {
                                                @Override
                                                public void onClick(View v) {
