...
class ChangelocationAdapter extends RecyclerView.Adapter<ChangelocationAdapter.PredictionHolder> implements Filterable {
    ...
    private ChangeLocationActivity clickListener;
...
//    }
    ...
    public void setClickListener(ChangeLocationActivity searchLocationActivity) {
...
//                                suid=intentBuilder.getStringExtra("suid");
                                ...
                                mContext.startActivity(new Intent(mContext, BagAvtivity.class).putExtra("suid",suid).putExtra("location",place.getAddress()));
